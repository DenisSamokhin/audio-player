...
#define kFe_Equalize_Width 200.0f
#define kFe_Equalize_Height 120.0f

#define kFe_Equalize_Bar_Width 40.0f
#define kFe_Equalize_Bar_Height 100.0f
...
-(void) initCommon
{
    _isShowing = NO;
    CGFloat originY = 100;
    self.frame = CGRectMake(0, originY, _containerView.bounds.size.width, _containerView.bounds.size.height-originY);
    self.backgroundColor = [UIColor clearColor];//[UIColor colorWithHexCode:@"#141517"];
}
...
-(void) initBars
{
    for (NSInteger i = 0; i < 5 ; i++)
    {
        ...
        if (i == 0)
        {
            ...
            _firstBar.fillColor = [UIColor whiteColor].CGColor;//[UIColor colorWithHexCode:@"#0B486B"].CGColor;
        ...
        if (i == 1)
        {
            ...
            _secondBar.fillColor = [UIColor whiteColor].CGColor;//[UIColor colorWithHexCode:@"#3B8686"].CGColor;
        ...
        if (i == 2)
        {
            ...
            _thirdBar.fillColor = [UIColor whiteColor].CGColor;//[UIColor colorWithHexCode:@"#79BD9A"].CGColor;
        ...
        if (i == 3)
        {
            ...
            _fourthBar.fillColor = [UIColor whiteColor].CGColor;//[UIColor colorWithHexCode:@"#A8DBA8"].CGColor;
        ...
        if (i == 4)
        {
            ...
            _fifthBar.fillColor = [UIColor whiteColor].CGColor;//[UIColor colorWithHexCode:@"#CFF09E"].CGColor;
...
-(void) initTitle
{
    ...
    _titleLbl.textColor = [UIColor whiteColor];//[UIColor colorWithHexCode:@"#CFF09E"];
    _titleLbl.font = [UIFont fontWithName:@"Helvetica-Bold" size:30];
    [_titleLbl sizeToFit];
